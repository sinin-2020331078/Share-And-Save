...
const SignUp = () => {
  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-orange-500 items-center justify-center p-12">
        <div className="max-w-md text-center text-white">
          <h1 className="text-4xl font-bold mb-6">Welcome to Share & Save</h1>
          <p className="text-xl mb-8">Join our community to share, save, and make a difference in your neighborhood.</p>
          <div className="space-y-4">
            ...
            <div className="flex items-center space-x-3">
              ...
              <span>Get access to exclusive deals</span>
            </div>
            <div className="flex items-center space-x-3">
              <div className="w-8 h-8 bg-white/20 rounded-full flex items-center justify-center">
